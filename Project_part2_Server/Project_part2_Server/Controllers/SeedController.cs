...
namespace Project_part2_Server.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public SeedController(UserManager<TaskUser> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration, TasksDatabaseContext context)
        {
